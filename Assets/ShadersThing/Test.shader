...
Shader "Test"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v )
		{
			...
			float2 temp_output_39_0 = ( _Offset * _Time.y );
			float2 uv_TexCoord23 = v.texcoord.xy * temp_cast_0 + temp_output_39_0;
			...
			float3 temp_output_40_0 = ( ( 1.0 - voroi65 ) * _WavesTess * ase_vertexNormal );
			v.vertex.xyz += temp_output_40_0;
			v.normal = temp_output_40_0;
		}
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 temp_cast_0 = (_Tiling).xx;
			float2 temp_output_39_0 = ( _Offset * _Time.y );
			float2 uv_TexCoord23 = i.uv_texcoord * temp_cast_0 + temp_output_39_0;
			float2 coords65 = uv_TexCoord23 * 1.0;
			float2 id65 = 0;
			float2 uv65 = 0;
			float fade65 = 0.5;
...
/*ASEBEGIN
Version=18301
0;647;1530;352;1979.203;361.1317;1.891108;True;False
...
Node;AmplifyShaderEditor.SimpleTimeNode;38;-2247.001,970.1551;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.Vector2Node;45;-2269.882,806.753;Inherit;False;Property;_Offset;Offset;15;0;Create;True;0;0;False;0;False;0,0;0.17,0.23;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;25;-2443.398,625.3608;Inherit;False;Property;_Tiling;Tiling;7;0;Create;True;0;0;False;0;False;0;9.19;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;39;-1997.241,906.5537;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.WireNode;83;-940.1113,964.12;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;86;-1552.064,86.71133;Inherit;False;Property;_Espuma;Espuma;12;0;Create;True;0;0;False;0;False;0.8699616,1,0,0;0,1,0.6555383,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;44;-1661.532,-482.3788;Inherit;False;Property;_WaterColor;Water Color;14;0;Create;True;0;0;False;0;False;0,0.6115854,1,0.5647059;0,0.9607843,0.46733,0.7137255;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;125;-1486.251,491.4729;Inherit;False;Property;_EspumaInterna;Espuma Interna;13;0;Create;True;0;0;False;0;False;1,0,0,0;0.2971698,1,0.3161968,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.WireNode;84;-1100.5,866.8064;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;23;-2133.331,590.3787;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;50;-759.77,-350.5514;Inherit;False;Property;_ReflexColor;Reflex Color;11;0;Create;True;0;0;False;0;False;1,0,0.01978827,0;0,0.2169811,0.04479611,1;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.OneMinusNode;42;-816.5598,850.2782;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;127;-618.124,115.9886;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.WorldPosInputsNode;144;-1888.567,635.8215;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.WireNode;142;-391.6685,-381.7814;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;145;-1576.803,706.6215;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT2;0,0;False;1;FLOAT3;0
...
WireConnection;0;12;40;0
ASEEND*/
//CHKSM=3DFFBD3332FDE9801362FC0F1514B2FD3D869259