...
public class RedEnemy : Enemy
{
    ...
    {
        base.Awake();
        fsm = new FSM<RedEnemy>(this);
        jumpingPad = GetComponent<SphereCollider>();
        fsm.AddState(StatesEnemies.Idle, new IdleRed(this, fsm));
        fsm.AddState(StatesEnemies.Shoot, new ShootRed(this, fsm));
    }
